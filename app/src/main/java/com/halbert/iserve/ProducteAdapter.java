...
public class ProducteAdapter extends RecyclerView.Adapter<ProducteAdapter.ViewHolder>  {
    ...
    public ProducteAdapter(Context context, List<Producte> producteList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull ProducteAdapter.ViewHolder holder, int position) {

        Producte producte = producteList.get(position);
        holder.nom.setText(producte.getNom());
         holder.descripcio.setText(producte.getDescripcio());
        holder.preu.setText(producte.getPreu());

        String imageUri = null;

        imageUri = producte.getImage();
